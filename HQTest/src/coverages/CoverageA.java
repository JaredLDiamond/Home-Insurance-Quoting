...
public class CoverageA extends CovSuper implements Interpolation {
    ...
    private static double Interpolated_Option = 0;
    private static double Interpolated_Factor = 0;
    ...
    private static double[] Option_Array = {50000, 52000, 54000, 56000, 58000, 60000, 62000, 64000, 66000, 68000, 70000, 72000, 74000, 76000, 78000, 80000,
    ...
    private static Double[][] Factor_Array = {{0.72, 0.735, 0.75, 0.765, 0.78, 0.794, 0.808, 0.821, 0.834, 0.847, 0.86, 0.872, 0.885, 0.897, 0.908, 0.92, 0.931, 0.942, 0.952, 0.962, 0.972, 0.981, 0.99, 0.996, 0.998, 1.00,
        ...
        2.427, 2.478, 2.529, 2.58, 2.63, 2.68, 2.73, 2.78, 2.83, 2.88, 2.93, 2.98, 3.03, 3.08}, {0.72, 0.735, 0.75, 0.765, 0.78, 0.794, 0.808, 0.821, 0.834, 0.847, 0.86, 0.872, 0.885, 0.897, 0.908, 0.92, 0.931, 0.942, 0.952, 0.962, 0.972, 0.981, 0.99, 0.996, 0.998, 1.00,
            1.046, 1.106, 1.137, 1.17, 1.216, 1.282, 1.347, 1.412, 1.474, 1.535, 1.59, 1.645, 1.7, 1.755, 1.81, 1.862, 1.914, 1.966, 2.018, 2.07, 2.121, 2.172, 2.223, 2.274, 2.325, 2.376,
...
//	}
	...
	public void interpolatePoints(double Lesser_Option_Amount, double Greater_Option_Amount, double Custom_Option_Amount) {
        ...
        double Lower_Factor = Factor_Array[0][Point_A];
        double Greater_Factor = Factor_Array[0][Point_B];
